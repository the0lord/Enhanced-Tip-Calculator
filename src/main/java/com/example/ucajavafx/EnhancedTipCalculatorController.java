package com.example.ucajavafx;// EnhancedTipCalculatorController.java
...
public class EnhancedTipCalculatorController {
   ...
   @FXML
   private TextField PerPeopleTextField;
   ...
   private void calculateButtonPressed(ActionEvent event) {
      try {
         ...
         BigDecimal x = total.divide(new BigDecimal(people));
         PerPeopleTextField.setText(currency.format(x));
